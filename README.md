...
- Data de entrega para avaliação regular do projeto: `03/04/2024 23:59h`
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH36&template=betrybe/sd-0x-store-manager)
